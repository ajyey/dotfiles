...
install_packages() {
  ...
  warn "Add these formulas to Brewfile: git, curl, stow, fish, fastfetch, starship, wezterm, zellij, eza, zoxide, fzf, fd, bat, ctop, wakeonlan, mise."

  log "Installing macOS packages with Homebrew"
  brew update
  brew install git curl stow fish fastfetch starship wezterm eza zoxide fzf fd bat ctop wakeonlan mise
}
